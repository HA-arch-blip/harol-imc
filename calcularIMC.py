...
def open_second_window():
    ...
    set_background(second_window, r"C:\Users\Equipo\OneDrive - Universidad Politecnica de Texcoco\Documentos\Codigo_IMC\BOTON QUE MARQUE IMC.jpg")  # Ruta de la imagen de fondo
    ...
    def calculate_bmi():
        try:
            ...
            set_background(result_window, r"C:\Users\Equipo\OneDrive - Universidad Politecnica de Texcoco\Documentos\Codigo_IMC\BOTON QUE MARQUE IMC.jpg")  # Ruta de la imagen de fondo
    ...
    calculate_image = resize_image(r"C:\Users\Equipo\OneDrive - Universidad Politecnica de Texcoco\Documentos\Codigo_IMC\BOTONN DE CALCULAR IMC.jpeg", 150, 80)
    calculate_hover_image = resize_image(r"C:\Users\Equipo\OneDrive - Universidad Politecnica de Texcoco\Documentos\Codigo_IMC\BOTONN DE CALCULAR IMC.jpeg", 150, 80)
    ...
    def open_third_window():
        ...
        set_background(third_window, r"C:\Users\Equipo\OneDrive - Universidad Politecnica de Texcoco\Documentos\Codigo_IMC\BOTON QUE MARQUE IMC.jpg")  # Ruta de la imagen de fondo

        third_image = resize_image(r"C:\Users\Equipo\OneDrive - Universidad Politecnica de Texcoco\Documentos\Codigo_IMC\BOTON DE TABLA IMC.jpg", 400, 400)
        tk.Label(third_window, image=third_image).pack()
        third_window.mainloop()

    info_image = resize_image(r"C:\Users\Equipo\OneDrive - Universidad Politecnica de Texcoco\Documentos\Codigo_IMC\BOTONN DE CALCULAR IMC.jpeg", 150, 80)
    info_hover_image = resize_image(r"C:\Users\Equipo\OneDrive - Universidad Politecnica de Texcoco\Documentos\Codigo_IMC\BOTONN DE CALCULAR IMC.jpeg", 150, 80)
...
set_background(root, r"C:\Users\Equipo\OneDrive - Universidad Politecnica de Texcoco\Documentos\Codigo_IMC\BOTON QUE MARQUE IMC.jpg")  # Ruta de la imagen de fondo

button_image = resize_image(r"C:\Users\Equipo\OneDrive - Universidad Politecnica de Texcoco\Documentos\Codigo_IMC\BOTON DEL CURSOR.jpeg", 250, 250)
